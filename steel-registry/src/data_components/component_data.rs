...
use super::components::{
    ...
    BlockTransformer, BlocksAttacks, BundleContents, ChargedProjectiles, Consumable, CustomData,
    CustomModelData, DamageResistant, DamageTypeComponent, DeathProtection, DebugStickState,
    DyedItemColor, Enchantable, EntityData, Equippable, FireworkExplosion, Fireworks,
    FoodProperties, InstrumentComponent, ItemAttributeModifiers, ItemContainerContents,
    ...
    ProvidesTrimMaterial, Rarity, Recipes, Repairable, SeededContainerLoot, SulfurCubeContent,
    SuspiciousStewEffects, SwingAnimation, Tool, TooltipDisplay, UseCooldown, UseEffects,
    UseRemainder, Weapon, WritableBookContent, WrittenBookContent,
};
...
impl_component_downcast_type!(BlockTransformer, "steel:item_component/block_transformer");
impl_component_downcast_type!(
