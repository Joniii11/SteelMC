...
pub use components::{
    ArmorTrim, BannerPatternLayer, BannerPatternLayers, BlockTransformer, BlocksAttacks,
    ...
    PotDecorations, PotionContents, ProvidesBannerPatterns, ProvidesPotteryPattern,
    ProvidesTrimMaterial, Recipes, SulfurCubeContent, Tool, ToolRule, ToolRuleBlocks, UseRemainder,
};
pub use registry::{
    ComponentEntry,
    ComponentEntryRef,
