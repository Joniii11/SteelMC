...
pub use super::components::{
    ...
    BlockEntityData, BlockItemStateProperties, BlockTransformer, BlocksAttacks, BundleContents,
    ChargedProjectiles, Consumable, CustomData, CustomModelData, DamageReduction, DamageResistant,
    DamageTypeComponent, DeathProtection, DebugStickProperty, DebugStickState, DyedItemColor,
    Enchantable, EntityData, Equippable, EquippableAllowedEntities, Filterable, FireworkExplosion,
    FireworkExplosionShape, Fireworks, FoodProperties, GlobalPos, InstrumentComponent,
    InvalidEnchantableValue, ItemAttributeModifierDisplay, ItemAttributeModifierEntry,
    ItemAttributeModifiers, ItemContainerContents, ItemDamageFunction, ItemEnchantments, ItemLore,
    ItemLoreTooLong, ItemUseAnimation, JukeboxPlayable, KineticWeapon, KineticWeaponCondition,
    LodestoneTracker, MapDecorationEntry, MapDecorations, MapId, MapItemColor, MapPostProcessing,
    ...
    Recipes, Repairable, SeededContainerLoot, SulfurCubeContent, SuspiciousStewEffect,
...
pub fn register_vanilla_data_components(registry: &mut DataComponentRegistry) {
    ...
    registry.register_with_codecs(
        BLOCK_TRANSFORMER,
        super::components::block_transformer::network_reader,
        super::components::block_transformer::network_writer,
        super::components::block_transformer::nbt_reader,
        super::components::block_transformer::nbt_writer,
    );
    ...
    registry.register_with_codecs(
        ...
        super::components::provides_pottery_pattern::network_reader,
        super::components::provides_pottery_pattern::network_writer,
        super::components::provides_pottery_pattern::nbt_reader,
        super::components::provides_pottery_pattern::nbt_writer,
    );
}
