...
use crate::{
    ...
    vanilla_chicken_sound_variants, vanilla_chicken_variants, vanilla_configured_features,
    ...
    vanilla_template_pools, vanilla_timeline_tags, vanilla_timelines, vanilla_trim_materials,
    vanilla_trim_patterns, vanilla_villager_professions, vanilla_villager_types,
    vanilla_wolf_sound_variants, vanilla_wolf_variants, vanilla_world_carvers,
...
pub const WORLD_CARVER_REGISTRY: Identifier = Identifier::vanilla_static("worldgen/carver");
