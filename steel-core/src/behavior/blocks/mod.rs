...
pub use vegetation::{
    ...
    MossyCarpetBlock, MushroomBlock, NetherFungusBlock, NetherRootsBlock, PathBlock,
    PointedDripstoneBlock, SaplingBlock, SculkVeinBlock, SeaPickleBlock, ShelfMushroomBlock,
