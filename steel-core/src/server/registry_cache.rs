...
use steel_registry::{
    ...
    DAMAGE_TYPE_REGISTRY, DECORATED_POT_PATTERN_REGISTRY, DIALOG_REGISTRY, DIMENSION_TYPE_REGISTRY,
    ENCHANTMENT_REGISTRY, ENTITY_TYPE_REGISTRY, FLUID_REGISTRY, FROG_VARIANT_REGISTRY,
    INSTRUMENT_REGISTRY, ITEMS_REGISTRY, JUKEBOX_SONG_REGISTRY, PAINTING_VARIANT_REGISTRY,
    PIG_SOUND_VARIANT_REGISTRY, PIG_VARIANT_REGISTRY, REGISTRY, Registry, RegistryEntry as _,
