...
pub(super) use steel_registry::feature::{
    ...
    DeltaFeatureConfiguration, DiskConfiguration, DripstoneClusterConfiguration, DualNoiseProvider,
    EndGatewayConfiguration, EndPodiumConfiguration, EndSpike, EndSpikeConfiguration,
    FallenTreeConfiguration, FeatureHeightmap, FeatureKind, FeatureNoiseParameters, FeatureRef,
