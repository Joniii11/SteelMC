...
//! Direct carvers mark geometry first; the chunk generator then visits the
//! marked ranges to apply aquifer and top-material behavior.
...
impl CarvingMask {
    ...
    pub fn new(min_y: i32, max_y: i32) -> Self {
        ...
        Self {
            ...
            max_y,
            height,
            bits: vec![0; total_bits.div_ceil(64)],
        }
    }
